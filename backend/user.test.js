...
function extractCourseCodes(input) {
    // input.replace("  ", " ");
    ...
    //   const department = match[1].replace(/\s/g, '_');
    //   const courseNumber = match[2];
    //   return `${department}_${courseNumber}`;
    // });
  
    // return result;
  }
  
  const inputString = "POLSC 1100,  2100, HIST  1100, or HIST  1200";
  const extractedCodes = extractCourseCodes(inputString);
